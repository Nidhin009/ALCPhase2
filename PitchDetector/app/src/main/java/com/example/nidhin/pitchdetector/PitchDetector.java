...
public class PitchDetector implements Runnable {
    ...
    private void PostToUI(final HashMap<Double, Double> frequencies,
        ...
        handler_.post(new Runnable() {
            public void run() {
                ...
                Logger.getLogger().appendLog("Current pitch is "+pitch);
            }
        });
    }
    ...
    public PitchDetector(MainActivity parent, Handler handler) {
    ...
    public void DoFFT(double[] data, int nn)
    {

        int i,j,m,mmax,n,istep;
